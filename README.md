...
### 4. Встановлення пакета
# Після додавання файлу pyproject.toml
`pip install .`
Або:
`pip install -e .`

## ▶️ Запуск застосунку
### Варіант 1 — після встановлення пакета (рекомендовано)
`personal-assistant`

### Варіант 2 — без встановлення (з репозиторію)
`python main.py`
...
| ---------------- | ---------------------------------- |
| `hello`          | Привітання.                        |
| `info`           | Показує список доступних команд.   |
